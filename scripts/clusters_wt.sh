...
python ./src/clustering/walktrap_clustering.py ./data/dsd/yeast/yeast_network_0_filtered_4.dsd -n ./data/dsd/yeast/yeast_network_0_filtered_4.nodelist > ./data/clusters/yeast_dsd_4_wt.txt
python ./src/clustering/walktrap_clustering.py ./data/dsd/yeast/yeast_network_0_filtered_4.5.dsd -n ./data/dsd/yeast/yeast_network_0_filtered_4.5.nodelist > ./data/clusters/yeast_dsd_4.5_wt.txt
python ./src/clustering/walktrap_clustering.py ./data/dsd/yeast/yeast_network_0_filtered_5.dsd -n ./data/dsd/yeast/yeast_network_0_filtered_5.nodelist > ./data/clusters/yeast_dsd_5_wt.txt
python ./src/clustering/walktrap_clustering.py ./data/dsd/yeast/yeast_network_0_filtered_5.5.dsd -n ./data/dsd/yeast/yeast_network_0_filtered_5.5.nodelist > ./data/clusters/yeast_dsd_5.5_wt.txt
python ./src/clustering/walktrap_clustering.py ./data/dsd/yeast/yeast_network_0_filtered_6.dsd -n ./data/dsd/yeast/yeast_network_0_filtered_6.nodelist > ./data/clusters/yeast_dsd_6_wt.txt
